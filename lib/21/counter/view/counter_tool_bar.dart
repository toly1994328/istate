...
class CounterToolBar extends StatelessWidget {
  ...
  Widget _buildCounterStep(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child:   GetX<AppCounterCtrl>(
          builder: (ctrl) => Text('步长 +${ctrl.state.value.step}', style: style)),
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
          ...
          border: Border(
              ...
              top: BorderSide(color: divColor, width: divSpace),
              bottom: BorderSide(color: divColor, width: divSpace),
          )),
      child: Row(
        children: [
          Padding(
