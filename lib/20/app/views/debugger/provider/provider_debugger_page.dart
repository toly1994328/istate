...
import 'change_notifier_proxy_provider_test_item.dart';
import 'future_provider_test_item.dart';
import 'listenable_provider_test_item.dart';
import 'package:provider/provider.dart';
import 'change_notifier_provider_test_item.dart';
import 'provider_test_item.dart';
import 'proxy_provider_test_item.dart';
import 'stream_provider_test_item.dart';

class ProviderDebuggerPage extends StatelessWidget {
  const ProviderDebuggerPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('provider 功能测试'),
